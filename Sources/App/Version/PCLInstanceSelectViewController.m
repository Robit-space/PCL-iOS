...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor=
        ...
        [UIColor colorWithRed:.88 green:.93 blue:1 alpha:1];
...
- (void)buildLeft {
    ...
    UIButton *back=[self button:@"返回启动页"
...
- (void)viewDidLayoutSubviews {
    ...
    [self.leftPanel viewWithTag:101].frame=CGRectMake(12,10,leftW-24,36);
    [self.leftPanel viewWithTag:102].frame=CGRectMake(20,58,leftW-40,18);

    UIView *folder=[self.leftPanel viewWithTag:103];
    folder.frame=CGRectMake(12,82,leftW-24,66);
    [folder viewWithTag:104].frame=CGRectMake(14,10,leftW-52,22);
    [folder viewWithTag:105].frame=CGRectMake(14,34,leftW-52,18);
    self.createButton.frame=CGRectMake(12,162,leftW-24,38);
    [self.leftPanel viewWithTag:107].frame=CGRectMake(12,204,leftW-24,38);

    CGFloat rw=self.rightPanel.bounds.size.width;
    self.searchBar.frame=CGRectMake(17,5,rw-34,49);
    self.tableView.frame=CGRectMake(0,54,rw,h-54);
    CGFloat cw=MIN(420,MAX(260,rw-80));
    self.emptyCard.frame=CGRectMake((rw-cw)/2,(h-170)/2,cw,170);
    self.emptyTitle.frame=CGRectMake(20,20,cw-40,28);
    self.emptyText.frame=CGRectMake(24,62,cw-48,42);
    self.emptyDownload.frame=CGRectMake((cw-140)/2,118,140,36);
}
...
- (NSString *)tableView:(UITableView *)t titleForHeaderInSection:(NSInteger)s {
    return [NSString stringWithFormat:@"可用实例 (%ld)",(long)self.shown.count];
}
...
- (UITableViewCell *)tableView:(UITableView *)t
    ...
    c.imageView.image=[UIImage systemImageNamed:@"shippingbox.fill"];
